    ...
    <div class="container py-4 py-lg-5">
        <div class="row justify-content-center">
            <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column">
                <h3 class="fs-6 fw-bold">TrendyCart</h3>
            ...
            <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column">
                <h3 class="fs-6 fw-bold">Address</h3>
                <ul class="list-unstyled">
                    <li style="color: #B0BDD3;">#123, Ground Floor</li>
                    <li style="color: #B0BDD3;">Sampaloc Street, Caloocan City</li>
                    <li style="color: #B0BDD3;">Metro Manila, Philippines</li>
                </ul>
            </div>
            <div class="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last">
                <div class="fw-bold d-flex align-items-center mb-2"><span class="bs-icon-sm bs-icon-circle bs-icon-primary d-flex justify-content-center align-items-center bs-icon me-2"><svg class="bi bi-bezier" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        </svg></span><span>TrendyCart</span></div>
                <p class="text-muted">Stay ahead of the game with TrendyCart's constantly updated selection of on-trend products</p>
            </div>
        </div>
        <hr />
        <div class="text-muted d-flex justify-content-between align-items-center pt-3">
            <p class="mb-0">Copyright © 2023 TrendyCart</p>
...
<script>
    ...
    if (isset($_SESSION['message'])) {
        //Success message
        if ($_SESSION['message'] == "Logged In Successfully." || $_SESSION['message'] == "Registered successfully" || $_SESSION['message'] == "Order placed successfully" ||  $_SESSION['message'] == "Product added to cart successfully" || $_SESSION['message'] == "Email subscribe successfully") {
    ?>
            $.notification(
                ["<?= $_SESSION['message'] ?>"], {
